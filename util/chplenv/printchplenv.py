...
def parse_args():
    ...
    build_parser = subparsers.add_parser('builds', usage ='usage: %(prog)s builds [options]')
    build_parser.print_help = lambda: stdout.write(printchplbuilds.help())
    ...
    parser.print_help = lambda: stdout.write(__doc__ + printchplbuilds.help())
